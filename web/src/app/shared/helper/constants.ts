...
export class Constants {
  ...
  public static gatewayUrl = environment.apiUrl;
  ...
  public static REGEX_USERNAME = /^[a-z0-9_-]{6,32}$/;
...
export class UrlAPI {
  ...
  public static validateUsername = Constants.gatewayUrl + '/users/validateUsername';
